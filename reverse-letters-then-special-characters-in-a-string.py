def reverse_letters_then_special_chars(s):
    ...
    while left < right:
        # If the character at the left pointer is not a letter, move the pointer to the right
        if not s[left].isalpha():
            left += 1
        # If the character at the right pointer is not a letter, move the pointer to the left
...
# Test the function
print(reverse_letters_then_special_chars("a%b,c"))